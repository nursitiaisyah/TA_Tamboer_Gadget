                                ...
                                <form action="proses_edit_varian.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" id="ram" name="ram" required>
                                            ...
                                            <option value="2GB" <?php echo ($varian['ram'] === '2GB') ? 'selected' : ''; ?>>2GB</option>
                                            <option value="4GB" <?php echo ($varian['ram'] === '4GB') ? 'selected' : ''; ?>>4GB</option>
                                            <option value="6GB" <?php echo ($varian['ram'] === '6GB') ? 'selected' : ''; ?>>6GB</option>
                                            <option value="8GB" <?php echo ($varian['ram'] === '8GB') ? 'selected' : ''; ?>>8GB</option>
                                            <option value="12GB" <?php echo ($varian['ram'] === '12GB') ? 'selected' : ''; ?>>12GB</option>
                                            <option value="16GB" <?php echo ($varian['ram'] === '16GB') ? 'selected' : ''; ?>>16GB</option>
                                        </select>
                                    </div>
                                    <!-- Warna -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" id="penyimpanan" name="penyimpanan"
                                            ...
                                            <option value="8GB" <?php echo ($varian['penyimpanan'] === '8GB') ? 'selected' : ''; ?>>8GB</option>
                                            <option value="16GB" <?php echo ($varian['penyimpanan'] === '16GB') ? 'selected' : ''; ?>>16GB</option>
                                            <option value="32GB" <?php echo ($varian['penyimpanan'] === '32GB') ? 'selected' : ''; ?>>32GB</option>
                                            <option value="64GB" <?php echo ($varian['penyimpanan'] === '64GB') ? 'selected' : ''; ?>>64GB</option>
                                            <option value="128GB" <?php echo ($varian['penyimpanan'] === '128GB') ? 'selected' : ''; ?>>128GB</option>
                                            <option value="256GB" <?php echo ($varian['penyimpanan'] === '256GB') ? 'selected' : ''; ?>>256GB</option>
                                            <option value="1TB" <?php echo ($varian['penyimpanan'] === '1TB') ? 'selected' : ''; ?>>1TB</option>
                                        </select>
                                    </div>
                                    <!-- Kondisi -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control form-control-sm" id="harga_masuk"
                                            name="harga_masuk" value="<?php echo $varian['harga_masuk']; ?>" required
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control form-control-sm" id="harga_jual"
                                            name="harga_jual" value="<?php echo $varian['harga_jual']; ?>" required
                                            style="max-width: 140px;">
                                    </div>
                                    <!-- Stok -->
                                    <div class="form-group">
